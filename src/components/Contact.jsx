      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-xl mx-auto">
            Feel free to contact me for any project ideas, questions, or just to say hello!
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  required
                  rows="5"
                  className="w-full p-3 bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
